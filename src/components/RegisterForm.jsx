        ...
        <form>
          ...
          <div className="form-group">
            ...
            <input
              ...
              onKeyUp={this.onKeyUp}
            />
            <small className={"form-text text-muted " + this.state.validPassword}>
          ...
          <div className="form-group">
            ...
            <select className="form-control" id="gender" name="gender" defaultValue={this.state.gender} onChange={this.onChange}>
              <option>Male</option>
